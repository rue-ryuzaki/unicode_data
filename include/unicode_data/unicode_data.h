...
typedef struct
{
    ...
    uint32_t combine;
    unicode_BIDI bidi;
    unicode_string_view decomposition;
    unicode_string_view decimal;
    unicode_string_view digit;
    unicode_string_view numeric;
    unicode_Mirror mirror;
    unicode_string_view old_name;
    unicode_string_view comment;
